...
#define _EMA_ALPHA 0.16    // EMA weight of new sample (range: 0 to 1)
                          // Setting EMA to 1 effectively disables EMA filter

// Servo adjustment - Set _DUTY_MAX, _NEU, _MIN with your own numbers
#define _DUTY_MAX 2250 // 2000
#define _DUTY_NEU 1520 // 1500
#define _DUTY_MIN 820 // 1000

#define _SERVO_ANGLE_DIFF  12.3  // Replace with |D - E| degree
...
// PID parameters
#define _KP 4.8  // proportional gain
#define _KD 240.0  // derivative gain
...
void loop() {
  ...
  if (event_dist) {
   ...
   // PID control logic
    ...
    //if((dist_ema>169)&&(dist_ema<195)) {
      //dterm = 230 * (error_current - error_prev);
      //pterm = 2.9 * error_current;
    //}
    //else {
     // dterm = _KD * (error_current - error_prev);
      //pterm = _KP * error_current;
...
float volt_to_distance(int a_value)
{
  ...
  return 625 - a_value * 3.06 + 5.71*0.001 * pow(a_value, 2) - 3.85*0.000001*pow(a_value, 3) ;
}
