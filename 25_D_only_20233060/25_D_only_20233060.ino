...
#define _INTERVAL_SERVO   15 // servo interval (unit: ms)
...
#define _DUTY_MAX 2184 // 2000
#define _DUTY_NEU 1495 // 1500
#define _DUTY_MIN 690 // 1000
...
#define _KD 35.0      // derivative gain
...
float volt_to_distance(int a_value)
{
  ...
  return 644 - a_value * 2.96 + 5*0.001 * pow(a_value, 2) - 3.04*0.000001*pow(a_value, 3) ;
}
